var submission = {
    "submissionDate":"2017-06-08",
    "submissionType": "FirstPartyMedicalProposal",
    "tenantCode" : "ebao",
...
function run() {
    ...
    dbapi.init()
    .then( status => {
        // let res = api.validateFirstPartyMedicalSubmission(submission)
        // console.log(res)
         api.processFirstPartyMedicalProposalSubmission(submission)
